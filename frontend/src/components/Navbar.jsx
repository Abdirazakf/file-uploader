        ...
        <nav className="sticky top-0 z-50 w-full border-b border-white/5 bg-background/60 backdrop-blur-md">
            <div className="max-w-7xl mx-auto px-6 h-14 flex items-center justify-between">
                ...
                <div className="flex items-center gap-6">
                    <Link to={'/login'}>
                        <button className="cursor-pointer text-sm font-medium text-zinc-300 hover:text-white">
                            Login
                        </button>
                    </Link>
                    <Link to={'/sign-up'}>
                        <button class="cursor-pointer text-sm font-medium bg-zinc-100 hover:bg-white text-black px-3 py-1.5 rounded-[4px] transition-colors">
                            Sign Up
                        </button>
                    </Link>
                </div>
